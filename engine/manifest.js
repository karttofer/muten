...
import { SUGGESTED, resolveToken } from './tokens.js';
...
export const KEYWORD_DOCS = {
  ...
  theme: 'The project theme block (theme.muten): `theme { space { md "16px" }  breakpoints { md "768px" }  base "…" }`. Supplies the token scale + reset; the engine owns only the vocabulary.',
